package com.lovehins.auth.server.interceptor;

import com.lovehins.auth.common.util.jwt.IJWTInfo;
import com.lovehins.auth.server.configuration.ClientConfiguration;
import com.lovehins.auth.server.service.AuthClientService;
import com.lovehins.auth.server.util.client.ClientTokenUtil;
import com.lovehins.base.sdk.exception.auth.ClientForbiddenException;
