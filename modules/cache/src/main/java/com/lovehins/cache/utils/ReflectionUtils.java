...
public class ReflectionUtils {
    ...
    public static void invokeSetter(Object obj, String propertyName, Object value) {
        ...
        for(int i = 0; i < names.length; ++i) {
            ...
            if(i < names.length - 1) {
                setterMethodName = "get" + StringUtils.capitalize(names[i]);
                object = invokeMethod(object, setterMethodName, new Class[0], new Object[0]);
            } else {
                setterMethodName = "set" + StringUtils.capitalize(names[i]);
                        ...
                        if(!type.equals(Long.TYPE) && !type.equals(Long.class)) {
                            if(!type.equals(Float.TYPE) && !type.equals(Float.class)) {
                                if(!type.equals(Double.TYPE) && !type.equals(Double.class)) {
                                    return type.equals(String.class)?(object == null?"":object.toString()):object;
                                } else {
